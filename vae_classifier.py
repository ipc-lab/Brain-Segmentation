...
if __name__ == '__main__':
    ...
    data, labels, input_shape = dl.get_Datas()
    print(input_shape)

    bigboi = BrainClassifierVAE(in_channels=53, input_side_dim=48, num_classes=8, model_depth=32)

    input = torch.rand((10, 53, 48, 48, 48))
